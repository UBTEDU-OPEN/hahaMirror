...
string CrackedUrl::get_hostname() { return this->hostname; }

string CrackedUrl::get_path() { return this->path; }

bool CrackedUrl::get_is_https() { return this->is_https; }

bool CrackedUrl::get_is_valid() { return this->is_valid; }

int CrackedUrl::get_error_code() { return this->error_code; }

unsigned int CrackedUrl::get_port() { return this->port; }

bool CrackedUrl::get_use_default_port() { return this->use_default_port; }

string CrackedUrl::to_string() const
{
    stringstream s;
