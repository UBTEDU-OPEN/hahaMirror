...
QT_MOC_LITERAL(1, 11, 20), // "sig_faceCountChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 3), // "cur"
QT_MOC_LITERAL(4, 37, 4) // "last"

    },
    "FaceDetect\0sig_faceCountChanged\0\0cur\0"
    "last"
};
...
void FaceDetect::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sig_faceCountChanged((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (FaceDetect::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&FaceDetect::sig_faceCountChanged)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void FaceDetect::sig_faceCountChanged(int _t1, int _t2)
{
